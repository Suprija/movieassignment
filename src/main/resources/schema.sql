...
create table history (id integer AUTO_INCREMENT,dates date,lang varchar(255),loc varchar(255),movie varchar(255),tickets integer,uname varchar(255),primary key (id));
